  ...
  return (
    <div style={{ background: "#F5F2EA", fontFamily: "'Inter', sans-serif", minHeight: "100vh", padding: "0 0 60px" }}>
      ...
      <div style={{ maxWidth: 460, margin: "40px auto 0", padding: "0 24px" }}>
        <div style={{ display: "inline-flex", alignItems: "center", gap: 8, background: "#EEF5F1", border: "1px solid rgba(45,107,79,0.25)", borderRadius: 999, padding: "7px 16px", fontSize: 13, fontWeight: 500, color: "#2D6B4F", marginBottom: 24 }}>
        ...
        <h1 style={{ fontFamily: "'Fraunces', serif", fontWeight: 400, color: "#1F3D2C", margin: "0 0 6px", lineHeight: 1.15 }}>
          <span style={{ fontSize: "1.5rem", fontWeight: 300, fontStyle: "italic", display: "block", color: "#6B756B" }}>You're almost there —</span>
      ...
      <div style={{ marginTop: 40, borderTop: "1px solid rgba(107,117,107,0.12)", paddingTop: 12, textAlign: "center" }}>
        <span style={{ fontSize: 11, fontWeight: 700, letterSpacing: "0.1em", color: "#9AA199", textTransform: "uppercase" }}>B — You're Almost There</span>
      </div>
    </div>
  );
}
