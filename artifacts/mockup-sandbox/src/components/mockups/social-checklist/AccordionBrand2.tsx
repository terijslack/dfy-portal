...
const PLATFORMS = [
  {
    ...
    steps: [
      "Go to business.facebook.com and log in with the Facebook account connected to your business page.",
  ...
  },
  {
    ...
    steps: ["Before completing these steps, please send a connection request to our Client Operations Manager on LinkedIn: Frankie Lanoue. LinkedIn only allows you to add someone as an admin if they are a 1st, 2nd, or 3rd degree connection, and in some cases they may need to follow your Page first. Once connected, continue below.","Log into LinkedIn and navigate to your Company Page (not your personal profile).","Click Admin Tools in the top right corner of your page.","Select Manage Admins.","Click Add Admin.","Search for our client operations manager's profile: Frankie Lanoue.","Select the admin role: choose Content Admin to allow us to create and manage content.","Click Save."],
