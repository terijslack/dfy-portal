/* Variant B — Logo as Hero Background Watermark
   Everything is identical to the real homepage.
   The only change: the hex logo mark is rendered large and low-opacity
   behind the hero section as a background element. */
...
export function VariantB() {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F5F2EA", color: "#6B756B" }}>
      ...
      {/* ── HERO — logo as background watermark ── */}
      <div style={{ position: "relative", overflow: "hidden" }}>

        {/* Watermark logo — large, low-opacity, centered in hero */}
        <div style={{
          position: "absolute",
          top: "50%",
          left: "50%",
