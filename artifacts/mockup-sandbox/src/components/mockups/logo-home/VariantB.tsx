/* Variant B — Logo in the Hero Eyebrow
   Everything is identical to the real homepage.
   The only addition: the hex logo mark sits inline with the "Done For You"
   eyebrow text just above the H1, giving the brand a visual anchor
   right before the main headline. */
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F5F2EA", color: "#6B756B" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .logo-highlight { animation: pulse-ring 2s ease-in-out infinite; border-radius: 50%; }
      `}</style>
      ...
      <section style={{ padding: "96px 48px 80px", maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
        <div>
          {/* ★ LOGO PLACEMENT: inline with eyebrow */}
          <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 20, position: "relative" }}>
            ...
            {/* Annotation */}
            <div style={{ position: "absolute", left: -4, top: -26, background: "#EBC99B", color: "#1F3D2C", fontSize: 10, fontWeight: 700, padding: "3px 8px", borderRadius: 4, whiteSpace: "nowrap", letterSpacing: "0.06em" }}>
              ★ LOGO HERE
            </div>
          </div>
