/* Variant A — Logo in the Nav Bar
   Everything is identical to the real homepage.
   The only addition: the hex logo mark sits to the left of "Done For You Marketing" in the nav. */
    ...
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F5F2EA", color: "#6B756B" }}>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        @keyframes pulse-ring {
          0%   { box-shadow: 0 0 0 0 rgba(235,201,155,0.70); }
      ...
      <nav style={{ background: "#fff", borderBottom: "1px solid rgba(31,61,44,0.10)", padding: "0 48px", height: 64, display: "flex", alignItems: "center", justifyContent: "space-between", position: "sticky", top: 0, zIndex: 10 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10, position: "relative" }}>
          ...
          {/* ★ LOGO PLACEMENT: left of the wordmark */}
          <div className="logo-highlight" style={{ display: "flex", alignItems: "center", justifyContent: "center", padding: 2 }}>
            <LogoMark size={30} />
          </div>

          {/* Annotation badge */}
          <div style={{ position: "absolute", top: -28, left: -4, background: "#EBC99B", color: "#1F3D2C", fontSize: 10, fontWeight: 700, padding: "3px 8px", borderRadius: 4, whiteSpace: "nowrap", letterSpacing: "0.06em" }}>
            ★ LOGO HERE
          </div>

          {/* Exact current wordmark */}
      ...
      <section style={{ padding: "96px 48px 80px", maxWidth: 1100, margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 64, alignItems: "center" }}>
        ...
        <div>
          ...
          <ul style={{ listStyle: "none", padding: 0, margin: "0 0 20px" }}>
            {[
              ...
              <li key={txt} style={{ display: "flex", alignItems: "flex-start", gap: 10, fontSize: 15, color: "#6B756B", marginBottom: 10 }}>
                <span style={{ color: "#2D6B4F", fontWeight: 700, fontSize: 15, flexShrink: 0, marginTop: 1 }}>
          ...
          <p style={{ fontSize: 17, lineHeight: 1.7, color: "#6B756B", marginBottom: 36, maxWidth: 440, fontWeight: 500, color: "#1F3D2C" }}>You focus on running your business. We'll handle the marketing.</p>
        ...
        {/* Right col — exact testimonial card */}
