/* Refinement 1 — Watermark anchored behind the right column
   Same hero, same content. The logo shifts to deliberately sit behind
   the testimonial card, making its presence feel intentional, not accidental.
   Opacity bumped to 0.09 for more presence. */

export function Refinement1() {
  return (
    <div style={{ fontFamily: "'Inter', sans-serif", background: "#F5F2EA", color: "#6B756B" }}>
      ...
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        {/* Watermark — anchored to right column, centered on the card */}
        <div style={{
          position: "absolute",
          right: "-4%",
          top: "50%",
