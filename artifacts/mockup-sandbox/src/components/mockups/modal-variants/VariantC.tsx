  ...
  return (
    <div className="min-h-screen bg-[#F5F2EA] flex items-center justify-center p-6">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-[680px] p-8">
        ...
        {/* Bottom bar: pill buttons left, main CTA right */}
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", borderTop: "1px solid rgba(31,61,44,0.07)", paddingTop: 18 }}>
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <button
              ...
              style={{
                background: action === "pause" ? "rgba(180,120,0,0.09)" : "transparent",
                border: `1.5px solid ${action === "pause" ? "#b47800" : "rgba(180,120,0,0.28)"}`,
                borderRadius: 20,
                color: "#7a5200",
                fontSize: 11,
                fontWeight: 600,
              ...
              <svg width="9" height="10" viewBox="0 0 9 10" fill="none">
                <rect x="0" y="0" width="3" height="10" rx="1" fill="#7a5200"/>
                <rect x="6" y="0" width="3" height="10" rx="1" fill="#7a5200"/>
              </svg>
              Pause
            </button>
            <button
              ...
              style={{
                background: action === "cancel" ? "rgba(125,42,3,0.07)" : "transparent",
              ...
              <svg width="9" height="9" viewBox="0 0 9 9" fill="none">
                <line x1="0.5" y1="0.5" x2="8.5" y2="8.5" stroke="#7D2A03" strokeWidth="1.5" strokeLinecap="round"/>
                <line x1="8.5" y1="0.5" x2="0.5" y2="8.5" stroke="#7D2A03" strokeWidth="1.5" strokeLinecap="round"/>
              </svg>
              Cancel
            </button>
          </div>

          {/* Right side: close + confirm */}
